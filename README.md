...
<table>
  <tbody>
    <tr> 
      <td align="center"><a href="https://github.com/jeongjinjoo"><img   src="https://github.com/beyond-sw-camp/be08-1st-SSACK3-Planners/blob/main/%EC%A0%95%EC%A7%84%EC%A3%BC.png"width="100px;" alt=""/><br /><b>🧸정진주(leader)</b></a><br /></td>
...
<br>
<br>
✔️ 회원가입과 로그인을 통해 개인정보를 입력하고, 다양한 파티룸들을 살펴보며 원하는 파티룸을 선택할 수 있습니다. <br>

✔️ 예약 시, 필요한 파티 용품 선택한 후 결제합니다. 
<br>
<br>
✔️ 파티룸 사용 빈도가 많을수록 등급이 업그레이드 됩니다. ( BRONZE, SILVER, GOID, PLATINUM, DIAMOND ) 
<br>
...
CREATE TABLE Reservation (
    ...
    check_out DATETIME  NOT NULL,
	 use_people INT NOT NULL, 
    room_id INT REFERENCES Partyroom(room_id),
...
CREATE TABLE Supplies_pay (
	supply_pay_id INT AUTO_INCREMENT PRIMARY KEY,
	amount INT NOT NULL,
...
|&nbsp;&nbsp;팀&nbsp;원&nbsp;&nbsp;&nbsp;|회고록|
|:----:|---|
|🧸정진주|<br>팀원들과 함께하는 첫 프로젝트에도 팀워크는 만족스러웠다. DB 설계 프로젝트가 처음인 우리들이 다함께 ERD설계부터 테스트까지 구현해내는 모습을 보면서 더 큰 프로젝트에도 도전해보고 싶어졌다. 가능하다면 다른 기능들도 추가해보고 싶다.<br>&nbsp;| 
|🐶강유성|<br>처음에는 간단해 보여 금방 구현할 것 같았는데 막상 구현해보니 생각 보다 많은 차이가 있는 것을 알 수 있었다. 기초설계의 중요성을 다시 한번 느끼게 되었다.<br>&nbsp;|
|🦊박성준|<br>시간에 쫓겨 기능을 위한 쿼리 구현을 급하게 마무리한 것이 아쉽습니다. 프로젝트 진행중에 수시로 바뀌는 테이블 구조를 보며 테이블 설계의 중요성을 느꼈습니다. 함께 해준 팀원들에게 감사합니다~<br>&nbsp;|
|🐥이은서|<br>처음 해보는 프로젝트여서 많이 부족했지만 팀원들의 도움으로 하나씩 해나갈 수 있었던 것 같습니다. 앞으로는 더 많은 부분에서 도움을 줄 수 있는 팀원이 될 수 있도록 노력하겠습니다!<br>&nbsp;|
|🐰정수진|<br>멋진 팀원들 덕분에 많이 프로젝트 기간 동안 많이 배울 수 있었던 좋은 시간이었다. 다들 고생하셨어요.<br>&nbsp;|
<br>
